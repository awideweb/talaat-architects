...
async function GET() {
    try {
        ...
        const projectsPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'src/data/projects.json');
        console.log('Looking for projects.json at:', projectsPath);
        console.log('Current working directory:', process.cwd());
        // Check if file exists
        try {
            await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].access(projectsPath);
        } catch  {
        ...
        // Read the file
        const projectsData = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].readFile(projectsPath, 'utf8');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b96b4d67._.js.map